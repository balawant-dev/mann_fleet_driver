...
import 'package:mann_fleet_driver/screen/bookingHistory/provider/bookingHistoryPro.dart';
import 'package:mann_fleet_driver/screen/cms/viewModel/cmsPro.dart';
import 'package:mann_fleet_driver/screen/corporateBookings/pro/corporate_booking_history_provider.dart';
import 'package:mann_fleet_driver/screen/corporateBookings/pro/corporate_booking_provider.dart';
import 'package:mann_fleet_driver/screen/fuel_entry/pro/fuelEntryPro.dart';
import 'package:mann_fleet_driver/screen/home_screen/provider/newBookingProvider.dart';
import 'package:mann_fleet_driver/screen/notification/provider/notificationPro.dart';
...
Future<void> main() async {
  ...
  /// -------------------------------------------------------------
  /// IMPORTANT
  /// Register background FCM ONLY ONCE
  /// -------------------------------------------------------------
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    /// Check after Flutter UI is ready
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    debugPrint("📱 DRIVER APP LIFECYCLE: $state");

    /// -----------------------------------------------------------
    /// VERY IMPORTANT
    /// Notification click se app resume hone ke baad
    /// pending incoming call check karo.
    /// -----------------------------------------------------------
  ...
  Future<void> _checkIncomingCall() async {
    try {
      debugPrint("🔍 DRIVER checking pending incoming call...");

      await FirebaseService.checkAndOpenIncomingCall();
    } catch (e, stackTrace) {
      debugPrint("❌ DRIVER pending call check error: $e");
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => ShuttleShiftProvider()),
        ChangeNotifierProvider(create: (_) => CorporateBookingProvider()),
        ChangeNotifierProvider(create: (_) => CorporateBookingHistoryProvider()),
      ],
