...
import '../provider/bookingDetailProvider.dart';
import 'package:provider/provider.dart';

class MyBookingScreen extends StatefulWidget {
  final String id;
  const MyBookingScreen({super.key,required this.id});
...
class _MyBookingScreenState extends State<MyBookingScreen> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<BookingDetailProvider>()
          .getNewBooking(context: context, id: widget.id);
    });}
  @override
