class EditVehicleDetailModel {
  bool? status;
  String? message;
  Data? data;

  EditVehicleDetailModel({this.status, this.message, this.data});

  EditVehicleDetailModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Driver {
  ...
  Driver({this.sId, this.name, this.id});
