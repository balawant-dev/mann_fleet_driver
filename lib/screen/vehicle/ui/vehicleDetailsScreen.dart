...
class _VehicleDetailsScreenState extends State<VehicleDetailsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<VehicleDetailsProvider>().getSegmentApi(context: context);
    });
  }
    ...
    return Consumer<VehicleDetailsProvider>(
      builder: (context, provider, child) {
        return Scaffold(
          ...
          appBar: const CommonAppBar(title: "Add Vehicle Details"),
          body: provider.isLoading && provider.getSegmentsModel == null
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildSingleImagePicker(
                  title: "RC Front Photo",
                  image: provider.rcFrontPhoto,
                  onPick: provider.pickRcFront,
                ),
                const SizedBox(height: 24),
      ...
      children: [
                  ...
                  child: Stack(
                    children: [
                      ClipRRect(
                        ...
                        child: Image.file(images[index], height: 100, width: 140, fit: BoxFit.cover),
                      ),
                      Positioned(
                        top: 4,
                        right: 4,
                        child: GestureDetector(
                          onTap: () => Provider.of<VehicleDetailsProvider>(context, listen: false)
        ...
        if (images.length < maxCount)
          OutlinedButton.icon(
            ...
            label: Text("Add ${images.isEmpty ? 'Photo' : 'More'}",style: TextStyle(color: ColorResource.primaryColor),),
          ),
      ],
    );
  }
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: image == null
                ? const Center(child: Text("Tap to upload", style: TextStyle(color: Colors.grey)))
                : ClipRRect(
              borderRadius: BorderRadius.circular(8),
